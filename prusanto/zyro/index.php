...
error_reporting(E_ALL); @ini_set('display_errors', true);
	$pages = array(
		...
		'1'	=> array('id' => '3', 'alias' => 'Contato', 'file' => '3.php')
	);
	$forms = array(
		'3'	=> array(
			'49b5ac7d' => Array( 'email' => 'rodrigojorge@gmail.com', 'subject' => 'Contato: Prusanto.com.br', 'sentMessage' => 'Obrigado pelo contato! Responderemos em breve!', 'fields' => array( array( 'fidx' => '0', 'name' => 'Nome', 'type' => 'input', 'options' => '' ), array( 'fidx' => '1', 'name' => 'E-mail', 'type' => 'input', 'options' => '' ), array( 'fidx' => '2', 'name' => 'Messagem', 'type' => 'textarea', 'options' => '' ) ) )
		)
	);
	$langs = null;
	$def_lang = null;
	...
	$user_key = "iIhYTLJ13WXroJZMml74";
	$user_hash = "16b12cfa86e919bd";
